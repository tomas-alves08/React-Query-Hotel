...
import { IBooking, IColor, ISalesData } from "../../utils/schemas";
...
interface IStyledSalesChartProps {
  children: ReactNode;
}
const StyledSalesChart: FC<IStyledSalesChartProps> = styled(DashboardBox)`
  grid-column: 1 / -1;
...
const SalesChart: FC<ISalesChartProps> = ({ bookings, numDays }) => {
  ...
  const colors: IColor = isDarkMode
    ? {
